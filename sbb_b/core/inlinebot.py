...
CATLOGO = "https://telegra.ph/file/890b1a1179dc1e1d89156.jpg"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ���� ⵧⵧⵧⵧⵧ⍣**\n[ ���� 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/aud9i)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/aud9i"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب أودِي **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/aud9i"),
                Button.url(
                    "المطور",
                    "t.me/b_idu",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل أودِي من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[���� 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/aud9i)",
